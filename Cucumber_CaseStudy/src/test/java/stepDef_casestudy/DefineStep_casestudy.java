...
public class DefineStep_casestudy {
...
public void alex_login_successfully_into_TestMeApp() {
	...
	/*
	 * @Given("Alexx has registered into TestMeApp") public void
	 * alexx_has_registered_into_TestMeApp() {
	 * 
	 * 
	 * // Write code here that turns the phrase above into concrete actions // throw
	 * new cucumber.api.PendingException(); }
	 * 
	 * @When("Alex search for a particular product like headphones") public void
	 * alex_search_for_a_particular_product_like_headphones() { Actions act =new
	 * Actions(driver);
	 * driver.findElement(By.xpath("//input[@id='myInput']")).sendKeys("Head");
	 * 
	 * //act.keyDown(search,
	 * Keys.SHIFT).sendKeys("H").pause(3000).sendKeys("e").pause(3000).sendKeys("a")
	 * .pause(3000).keyUp(Keys.SHIFT).perform();
	 * act.moveToElement(driver.findElement(By.xpath(
	 * "//div[contains(text(),'Headphone')]"))).click().perform();
	 * driver.findElement(By.xpath("//form//input[@name='val']")).click(); // Write
	 * code here that turns the phrase above into concrete actions //throw new
	 * cucumber.api.PendingException(); }
	 * 
	 * @When("try to proceed to payment without adding any item in the cart") public
	 * void try_to_proceed_to_payment_without_adding_any_item_in_the_cart() { //
	 * Write code here that turns the phrase above into concrete actions //throw new
	 * cucumber.api.PendingException(); }
	 * 
	 * @Then("TestMeApp doesn't display the cart icon") public void
	 * testmeapp_doesn_t_display_the_cart_icon() { // Write code here that turns the
